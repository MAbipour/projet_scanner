...
//			send_to_computer = !send_to_computer;
			...
			//if ((lineWidth>60) & (lineWidth<90)){		//détection cible avec petite ligne
			if(cam_mode==CAMERA_ON){
				...
				//if ((lineWidth>160) & (lineWidth<250)){		//détection cible avec grande ligne
    		...
    		start_motor_rot_long();				//permet au robot d'éloigner le capteur de distance de l'objet
    		stop_motor();
